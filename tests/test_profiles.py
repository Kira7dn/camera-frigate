...
from frigate.infrastructure.config.camera.profile import CameraProfileConfig
from frigate.infrastructure.config.profile import ProfileDefinitionConfig
from frigate.infrastructure.config.profile_manager import PERSISTENCE_FILE, ProfileManager
...
class TestProfileManager(unittest.TestCase):
    ...
    def test_activate_profile_adds_zone(self, mock_persist):
        ...
        from frigate.infrastructure.config.camera.zone import ZoneConfig
