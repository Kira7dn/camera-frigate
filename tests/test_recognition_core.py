...
from frigate.application.recognition.face import FaceEngine
from frigate.application.recognition.lpr import LprEngine
...
def test_import_isolation():
    forbidden = (
        "frigate.infrastructure.comms",
        "frigate.application.events",
        "frigate.domain.object_detection",
        "frigate.application.embeddings.maintainer",
    )
    before = set(sys.modules)
    module = importlib.reload(importlib.import_module("frigate.application.recognition"))
...
def test_import_isolation_in_fresh_interpreter():
    script = """
import json, sys
import frigate.application.recognition
