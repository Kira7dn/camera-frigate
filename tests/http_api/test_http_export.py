...
class TestHttpExport(BaseTestHttp):
    ...
    def test_delete_export_case_delete_exports_cancels_queued_jobs(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                patch("frigate.application.jobs.export._job_manager", None),
                patch(
                    "frigate.application.jobs.export.ExportJobManager.ensure_started",
                    autospec=True,
                    return_value=None,
                ),
            ):
    ...
    def test_single_export_returns_503_when_queue_full(self):
        ...
        from frigate.application.jobs.export import ExportQueueFullError
