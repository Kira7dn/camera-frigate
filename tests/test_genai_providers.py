...
from frigate.infrastructure.config import GenAIConfig, GenAIProviderEnum
...
class TestOllamaProvider(unittest.TestCase):
    ...
    def _run_with_response(self, client, response, messages):
        ...
        with patch(
            "frigate.application.genai.plugins.ollama.OllamaAsyncClient",
    ...
    def test_normalize_multimodal_content(self):
        from frigate.application.genai.plugins.ollama import _normalize_multimodal_content
...
class TestLlamaCppProvider(unittest.TestCase):
    ...
    def _run_with_lines(self, client, lines, messages):
        with patch(
            "frigate.application.genai.plugins.llama_cpp.httpx.AsyncClient",
