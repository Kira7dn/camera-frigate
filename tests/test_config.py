...
from frigate.infrastructure.config.camera.camera import CameraConfig
from frigate.infrastructure.config.classification import FaceRecognitionConfig
...
class TestConfig(unittest.TestCase):
    ...
    @patch("frigate.domain.detectors.detector_config.load_labels")
