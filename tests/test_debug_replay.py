...
Startup orchestration lives in ``frigate.application.jobs.debug_replay`` (covered by
...
class TestDebugReplayManagerStop(unittest.TestCase):
    ...
    def test_stop_publishes_remove_when_camera_was_published(self) -> None:
        from frigate.infrastructure.config.camera.updater import CameraConfigUpdateEnum
        from frigate.debug_replay import DebugReplayManager
