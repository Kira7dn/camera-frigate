...
import frigate.domain.detectors as detectors
import frigate.domain.object_detection.base
from frigate.infrastructure.config import DetectorConfig, ModelConfig
from frigate.domain.detectors import DetectorTypeEnum
from frigate.domain.detectors.detector_config import InputTensorEnum
...
class TestLocalObjectDetector(unittest.TestCase):
    def test_localdetectorprocess_should_only_create_specified_detector_type(self):
        for det_type in detectors.api_types:
            with self.subTest(det_type=det_type):
                with patch.dict(
                    "frigate.domain.detectors.api_types",
                    ...
                    test_obj = frigate.domain.object_detection.base.LocalObjectDetector(
    ...
    def test_detect_raw_given_tensor_input_should_return_api_detect_raw_result(self):
        ...
        test_obj_detect = frigate.domain.object_detection.base.LocalObjectDetector(
    ...
    @patch("frigate.domain.object_detection.base.load_labels")
