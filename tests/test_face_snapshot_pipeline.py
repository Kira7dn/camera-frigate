...
import frigate.infrastructure.data_processing.real_time.face as face_module
from frigate.infrastructure.data_processing.real_time.face import FaceRealTimeProcessor
from frigate.application.recognition.adapters.frigate import FrigateEventAdapter
from frigate.application.recognition.contracts import RecognitionTask, RecognitionUpdate, TrackKey
