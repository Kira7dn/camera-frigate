...
from frigate.infrastructure.data_processing.common.license_plate.constants import LPR_EMBEDDING_SIZE
from frigate.domain.detectors.detection_runners import BaseModelRunner, get_optimized_runner
from frigate.application.embeddings.types import EnrichmentModelTypeEnum
