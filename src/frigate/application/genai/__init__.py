...
from frigate.infrastructure.config import CameraConfig, GenAIConfig, GenAIProviderEnum
from frigate.const import CLIPS_DIR
from frigate.infrastructure.data_processing.post.types import ReviewMetadata
from frigate.application.genai.manager import GenAIClientManager
from frigate.application.genai.prompts import (
...
def load_providers() -> None:
    ...
    for filename in os.listdir(plugins_dir):
        if filename.endswith(".py") and filename != "__init__.py":
            module_name = f"frigate.application.genai.plugins.{filename[:-3]}"
