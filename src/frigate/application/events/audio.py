...
from frigate.infrastructure.config import CameraConfig, CameraInput, FrigateConfig
from frigate.infrastructure.config.camera.ffmpeg import CameraFfmpegConfig
...
from frigate.infrastructure.data_processing.common.audio_transcription.model import (
    AudioTranscriptionModelRunner,
)
from frigate.infrastructure.data_processing.real_time.audio_transcription import (
