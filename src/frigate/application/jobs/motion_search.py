...
from frigate.application.jobs.job import Job
from frigate.application.jobs.manager import (
    get_job_by_id,
    set_current_job,
)
from frigate.application.jobs.motion_search_batch import (
    build_segment_time_map,
    coalesce_runs,
    stream_time_to_absolute,
)
from frigate.application.jobs.motion_search_decode import (
    iter_vod_frames,
