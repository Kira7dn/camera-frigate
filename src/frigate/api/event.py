...
from frigate.infrastructure.comms.event_metadata_updater import EventMetadataTypeEnum
...
from frigate.application.embeddings import EmbeddingsContext
from frigate.models import Event, ReviewSegment, Timeline, Trigger
from frigate.domain.track.object_processing import TrackedObject
