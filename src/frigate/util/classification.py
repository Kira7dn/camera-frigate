...
from frigate.infrastructure.comms.embeddings_updater import EmbeddingsRequestEnum, EmbeddingsRequestor
from frigate.infrastructure.comms.inter_process import InterProcessRequestor
from frigate.infrastructure.config import FfmpegConfig
