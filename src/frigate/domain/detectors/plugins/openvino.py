...
from frigate.domain.detectors.detection_runners import OpenVINOModelRunner
from frigate.domain.detectors.detector_config import BaseDetectorConfig, ModelTypeEnum
