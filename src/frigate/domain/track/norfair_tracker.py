...
from frigate.infrastructure.config import CameraConfig
from frigate.domain.ptz.autotrack import PtzMotionEstimator
from frigate.domain.track import ObjectTracker
from frigate.domain.track.stationary_classifier import (
