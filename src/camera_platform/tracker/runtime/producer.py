"""Serialize existing Frigate tracker observations for an edge transport.

This module consumes the shared lifecycle projection. It does not implement detection,
Norfair association, zones, speed, recording, or PTZ behavior.
"""
...
class TrackerProducerCore:
    """Normalize one shared lifecycle observation into the edge wire contract."""
