...
from frigate.application.recognition.contracts import RecognitionArtifact, RecognitionTask, TrackedObservation
from frigate.application.recognition.ports import ModelRecognition, RawRecognition
...
class _Requestor(InterProcessRequestor):
    def send_data(self, topic: str, data: Any = None) -> None:
        return None
