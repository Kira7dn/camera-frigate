...
Usage (from the repository root):
    ...
    python3 tools/generators/generate_api_auth_spec.py            # write the spec
    python3 tools/generators/generate_api_auth_spec.py --check    # CI guard: fail if stale
...
HEADER = (
    "# Generated by tools/generators/generate_api_auth_spec.py — do not edit by hand.\n"
    "# Regenerate with:  python3 tools/generators/generate_api_auth_spec.py\n"
